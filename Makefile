...
OMP_ARM	      = -fopenmp	
OMP_FUJITSU   = -Kopenmp -Kopenmp_assume_norecurrence
OMP=$(OMP_$(COMPILER))
...
CFLAGS_PGI       = -fastsse -gopt -Mipa=fast -Mlist -g
CFLAGS_PATHSCALE = -O3
...
#CFLAGS_ARM       = -O3 -march=armv8.1-a -mcpu=native -g
CFLAGS_ARM       = -O3 -mcpu=native -g
CFLAGS_FUJITSU   = -O3 -KA64FX -g
CFLAGS_          = -O3
